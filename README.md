...
-   The `model.frame.libFM()` function converts data into libFM (also LIBSVD) format
...
This gives a mean squared error of 0.8186918 with dimension 10.
...
This gives a mean squared error of 0.8882225, nearly the same as ridge regression.
